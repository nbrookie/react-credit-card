...
var ReactCreditCard = function ReactCreditCard(props) {
  ...
  }), isAmex && /*#__PURE__*/React.createElement("div", {
  ...
  }, formatCvc(props.cvc, cardInfo.cvcLength)), /*#__PURE__*/React.createElement("img", {
  ...
  }, formatNumber((props.number || '').replace(/\s+/g, ''), cardInfo)), /*#__PURE__*/React.createElement("div", {
  ...
  }, !props.name ? props.placeholderName : props.name), /*#__PURE__*/React.createElement("div", {
  ...
  }, formatExpiration((props.expiration || '').replace(/\s+/g, ''))))), /*#__PURE__*/React.createElement("div", {
...
export { ReactCreditCard, ReactCreditCard as default };
//# sourceMappingURL=react-credit-card.js.map
